...
and at $\kappa=0$, checking the seven endpoint identities
$H(0)=P(0)=A(0)=0$, $H(1)=-H_\star$, $P(1)=-P_\star$,
and $G_\star=H_\star+P_\star\approx0$ (with $H_\star$, $P_\star$ the
entropy and constraint halves of the free energy), and the
conditional-mean check resolving at $10^{-12}$ or better at every
