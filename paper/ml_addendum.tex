...
$\alpha_\star(\kappa)$ ($0.90$ at $N=101$, $0.75$ at $N=201$, $0.69$
at $N=301$, flat across margins to a few percent), so the demanded
...
the fraction falls with $N$, so holding a constant fraction of
capacity requires superlinearly growing total work; at $N=201$ the
fraction climbs $0.75$, $0.79$, $0.86$ as the budget quadruples
twice, consistent with a fixed gain per quadrupling over the
measured range.
