...
$\kappa=0.185$ (contraction $0.830$, inwardness above $1.1\cdot
10^{-4}$; \texttt{rect\_cond31\_0p185.json}) just as at
$\kappa=0.13$, so both lane endpoints carry the full
Condition~\ref{cond:fp}.  Certifying every interior slab is those
...
endpoints $\kappa\in\{0.13,0.185\}$.  In every case
...
chain.  The checker also enforces two global completeness clauses on
...
$(0.10,0.19]$, and the rectangle clause again at $\kappa\in\{0.13,0.185\}$
