...
chain.  Two global completeness clauses --- that radial chains reach
the stated outer radius, and that angular runs close the full circle
--- are not yet enforced mechanically by either the portable checker
or the Lean layer; the shipped manifests satisfy both on direct
inspection, and enforcing them is the next hardening step, since a
malformed future artifact could otherwise pass the stated checks.
