...
\emph{Exact artifacts and replay.}  Certificates carry every
...
bookkeeping, not the inequalities.)  A
...
only on Condition~\ref{cond:2var} at the margin in question.  The lower
