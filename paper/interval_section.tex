...
implicitly.  The minimum band margins at the three positive margins
($4.7\cdot10^{-5}$, $2.7\cdot10^{-4}$, $1.9\cdot10^{-4}$) moreover
differ far less than a unit derivative would predict over those
$\kappa$ gaps, suggesting the thin-trough values are slowly varying
along the branch and the effective pitches are wider still; a
per-band finite-difference measurement at one margin would settle
that constant before any machinery is built.
